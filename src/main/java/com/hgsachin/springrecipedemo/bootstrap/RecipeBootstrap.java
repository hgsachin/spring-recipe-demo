package com.hgsachin.springrecipedemo.bootstrap;

import com.hgsachin.springrecipedemo.domain.*;
import com.hgsachin.springrecipedemo.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<Category> tandoorCategoryOptional = categoryRepository.findByDescription("Tandoor");

        if(!tandoorCategoryOptional.isPresent()){
            throw new RuntimeException("Expected Category Not Found");
        }

        Category indianCategory = indianCategoryOptional.get();
        Category tandoorCategory = tandoorCategoryOptional.get();
        ...
        guacRecipe.getCategories().add(tandoorCategory);
        ...
        tacosRecipe.getCategories().add(tandoorCategory);
